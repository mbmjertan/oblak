...
$ns = new Nightsparrow;
$oblak = new OblakCore;
$msg = '<div class="alert alert-success"><b>Da biste nastavili, unesite kratko ime svoje instance</b> ili se prijavite putem poveznice za prijavu vaše instance.</div>';
