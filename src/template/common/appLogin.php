...
<head>
  ...
  <title>Prijavite se &middot; Poslovni oblak</title>
  ...
  <form action="/applogin" class="form-signin" method="post">
    ...
    <div class="row">
      <div class="input-field col s12">
        <label for="instance">Kratko ime instance</label>
        <input type="text" name="instance" class="input-field" required>
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
    ...
    <div class="row">
      <div class="col l7 s12">
        <button class="btn blue-grey darken-2">Prijavite se</button>
      </div>
      <div class="col l5 s12 actionLink">
        <a href="<?php echo domainpath; ?>">Nemate instancu?</a>
      </div>
    </div>
