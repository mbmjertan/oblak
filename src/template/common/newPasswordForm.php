...
<head>
  ...
  <title>Promjena lozinke &middot; Poslovni oblak</title>
...
<div class="container">
  <form action="<?php echo domainpath . activeInstance;?>/login" class="form-signin" method="post">
    ...
    <input type="hidden" name="prtoken" value="<?php echo $oblak->ioPrepare($routeSegments[3]); ?>">
    <input type="hidden" name="action" value="finalpasswordreset">


    <p><b>Skoro pa gotovo.</b> Unesite novu lozinku.</p>
    <div class="input-field">
      <input type="password" name="resetpassword" placeholder="Lozinka" class="form-control" required>
    </div>
    <div class="row">
